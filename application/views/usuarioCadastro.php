...
<html>
    ...
    <body>
        ...
        <input type="text" required placeholder="Nome aqui..." name="nomeUsuario"/>
            ...
            <input type="radio" value="admin" name="perfilAcesso">Administrador
            <input type="radio" value="user" name="perfilAcesso">Usuário
            <br><br>
        ...
        <table>
            <thead>
                <tr>
                    <th>Nome</th><th>User1</th><th>Perfil Acesso</th><th>Funções</th>
                </tr>
            </thead> 
            <tbody>
